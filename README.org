...
* Notes:
   The unindent and indent functions take the text in a file to output a string, as well as create a new file with the text.
   This can be seen in main.cpp. The main file prints the text unindented, then prints the text correctly indented, and creates files with the text.
